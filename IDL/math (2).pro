...
;  dims0[2]=999
  ...
  name=make_array(132,/string)
  name1=make_array(132,/string)
  a=0

  for y=2000,2010,1 do begin
  
  	for m=1,12,1 do begin
  	
  	name[a]='NDVI_MJ_'+string(y,format='(i4)')+string(m,format='(I2.2)')
  	name1[a]='J:\NDVI_CN\byte\NDVI_CN_'+string(y,format='(i4)')+string(m,format='(I2.2)')
  	a=a+1
  	endfor
  endfor
