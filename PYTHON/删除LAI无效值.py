...
##########################-----公用目录---------##############################################		
		input_dir="K:\\Data\\LAI\\"	#气象数据所在的目录
		input_dir1="K:\\Data\\LAI\\LAI\\"
...
################################################################################
		...
		# Process: 条件函数 提取出有效值
#		arcpy.gp.Con_sa(output_asctoras, output_asctoras, output_asctoras1, "0", "\"Value\" <=200 AND \"Value\" >=0")
		# Process: 设为空函数
...
#		arcpy.DefineProjection_management(output_asctoras, "GEOGCS['GCS_WGS_1984',DATUM['D_WGS_1984',SPHEROID['WGS_1984',6378137.0,298.257223563]],PRIMEM['Greenwich',0.0],UNIT['Degree',0.0174532925199433]]")
		# Local variables:
		LAI200001_tif = "LAI200001.tif"
		setnum = "0"
		IsNull_Int_t1 = "C:\\Users\\ln1267\\Documents\\ArcGIS\\Default.gdb\\IsNull_tif1"
		Con_IsNull_I1 = "C:\\Users\\ln1267\\Documents\\ArcGIS\\Default.gdb\\Con_IsNull_t1"
		# Process: 删除
		arcpy.Delete_management(IsNull_Int_t1, "")
		# Process: 为空
		arcpy.gp.IsNull_sa(output_asctoras, IsNull_Int_t1)

		# Process: 条件函数
		arcpy.gp.Con_sa(IsNull_Int_t1, setnum, output_asctoras1, output_asctoras, "VALUE =1")
