...
#循环开始
for n in xrange(2009,2013):
	for m in xrange(1,13):
		m="%02d" % m		#转换为两位日期
# Local variables:	
												#如果处理气象数据统计字段为"HUC_8"，统计LAI是则为”HUC_8"
		data_class="PRE"							#待处理的数据类型”TM“，”PRE“，”LAI“
...
##########################-----公用目录---------##############################################		
		input_dir="K:\\Data\\Yuzhen\\Climate_5KM\\"+data_class+"\\"	#气象数据所在的目录
		input_dir1="K:\\Data\\Yuzhen\\Climate\\"+data_class+"\\"
...
################################################################################
		...
		# Process: 设为空函数
		arcpy.gp.SetNull_sa(output_asctoras, output_asctoras, output_asctoras1, "value < 0")
